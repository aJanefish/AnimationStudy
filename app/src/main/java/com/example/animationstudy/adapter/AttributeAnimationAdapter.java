...
public class AttributeAnimationAdapter extends RecyclerView.Adapter<AttributeAnimationAdapter.Holder> {

    private List<Bean> mList = new ArrayList();
    private AnimationCallBack mAnimationCallBack;

    public AttributeAnimationAdapter(List<Bean> list, AnimationCallBack animationCallBack) {
    ...
    public static class Holder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            mAnimationCallBack.callBack(mBean.animator);
        }
    }
    ...
    public static class Bean {
        ...
        public Bean(String des, Animator animator) {
            this.des = des;
